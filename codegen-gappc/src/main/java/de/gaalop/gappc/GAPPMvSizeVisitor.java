...
public class GAPPMvSizeVisitor extends de.gaalop.gapp.visitor.CFGGAPPVisitor {
    ...
    public Object visitDotVectors(GAPPDotVectors gappDotVectors, Object arg) {
        incrementSize(GAPPCCodeGenerator.getVarName(gappDotVectors.getDestination().getName()),1);        
        return null;
    }

    @Override
    public Object visitResetMv(GAPPResetMv gappResetMv, Object arg) {
        getMvSizes().put(GAPPCCodeGenerator.getVarName(gappResetMv.getDestination().getName()), 0);
        return null;
    }

    @Override
    public Object visitSetMv(GAPPSetMv gappSetMv, Object arg) {
        incrementSize(GAPPCCodeGenerator.getVarName(gappSetMv.getDestination().getName()),
    ...
    public Object visitCalculateMvCoeff(GAPPCalculateMvCoeff gappCalculateMvCoeff, Object arg) {
        incrementSize(GAPPCCodeGenerator.getVarName(gappCalculateMvCoeff.getDestination().getName()),1);        
        return null;
    }
