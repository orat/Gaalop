...
/**
 * This class implements the CFG and DFG visitor that generate Maxima code.
 */
public class MaximaVisitor extends DefaultCodeGeneratorVisitor {

    // + once/multiple
    // \w alphanumerical character or "_"
    // \d number
    ...
    public void visit(StartNode node) {
        graph = node.getGraph();
        code.append("display2d:false;\n");
        code.append("ratprint:false;\n");
        code.append("keepfloat:true;\n");
