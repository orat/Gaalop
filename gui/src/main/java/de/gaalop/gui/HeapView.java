...
class HeapView extends JComponent {
    ...
    static {
        ...
        c = UIManager.getColor("Label.background");
        if (null == c) {
        ...
        c = UIManager.getColor("Button.highlight"); //NOI18N
        if (null == c) {
    ...
    protected void processMouseEvent(MouseEvent e) {
        ...
        if (e.getID() == MouseEvent.MOUSE_CLICKED
            ...
            Thread t1 = new Thread(new GarbageCollection());
            t1.start();
        }
    }
    ...
    private void startTimerIfNecessary() {
        ...
        if (updateTimer == null) {
            updateTimer = new Timer(TICK, (ActionEvent e) -> {
                update();
            });
