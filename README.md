...
- You can open a shell and with the command "java -version" you can test if Java is well configured, which means that you get the Java virtual machine in the current version.
